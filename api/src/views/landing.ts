...
<body class="min-h-screen">
  ...
  <section class="py-20 px-4 sm:px-6">
    <div class="max-w-5xl mx-auto">
      <div class="text-center mb-14">
        <h2 class="text-3xl sm:text-4xl font-bold text-ghText">Choose your setup</h2>
        <p class="mt-4 text-ghMuted text-lg max-w-xl mx-auto">Use it hosted or run it yourself. Same app, your choice.</p>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
        <!-- Hosted -->
        <div class="bg-ghCard border-2 border-ghBlue rounded-ghLg p-8 relative">
          <span class="absolute -top-3 left-6 bg-ghBlue text-white text-xs font-bold px-3 py-1 rounded-full">Recommended</span>
          <h3 class="text-2xl font-bold text-ghText mb-2">Hosted</h3>
          <div class="flex items-baseline gap-1 mb-6">
            <span class="text-4xl font-bold text-ghText">$2</span>
            <span class="text-ghMuted">/month</span>
          </div>
          <ul class="space-y-3 mb-8 text-sm text-ghMuted">
            <li class="flex items-center gap-2"><i class="fa-solid fa-check text-ghGreen"></i> Instant setup — no servers needed</li>
            <li class="flex items-center gap-2"><i class="fa-solid fa-check text-ghGreen"></i> Managed infrastructure</li>
        ...
        <!-- Self-hosted -->
        <div class="bg-ghCard border border-ghBorder rounded-ghLg p-8">
          <h3 class="text-2xl font-bold text-ghText mb-2">Self-Hosted</h3>
          <div class="flex items-baseline gap-1 mb-6">
            <span class="text-4xl font-bold text-ghText">Free</span>
            <span class="text-ghMuted">forever</span>
          </div>
          <ul class="space-y-3 mb-8 text-sm text-ghMuted">
            <li class="flex items-center gap-2"><i class="fa-solid fa-check text-ghGreen"></i> Full control over your data</li>
            <li class="flex items-center gap-2"><i class="fa-solid fa-check text-ghGreen"></i> Deploy anywhere with Docker</li>
            <li class="flex items-center gap-2"><i class="fa-solid fa-check text-ghGreen"></i> MIT licensed — fork it, hack it</li>
            <li class="flex items-center gap-2"><i class="fa-solid fa-check text-ghGreen"></i> Community supported</li>
          </ul>
          <a href="https://github.com/UnlikeOtherAI/github-watch"
             class="flex w-full items-center justify-center gap-2 border border-ghBorder hover:border-ghMuted text-ghText font-semibold py-3 rounded-gh transition-colors">
            <i class="fa-brands fa-github"></i>
            View on GitHub
          </a>
        </div>
